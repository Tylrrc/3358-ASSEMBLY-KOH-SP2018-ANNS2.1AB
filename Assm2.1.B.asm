##########################################################################
# Tyler Cummings, CS 2318-260, Assignment 2 Part 1 Program B
#
#	Description: This program prompts the user to input two integers, 
#		then returns a value (0-3) that corresponds to whether
#		the values are even-even, even-odd, odd-even, odd-odd.
#
############################ data segment ################################
